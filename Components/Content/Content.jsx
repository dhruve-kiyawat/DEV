      ...
      <Container>
        <div className={classes.inner}>
          <div className={classes.content}>
            ...
            >
              <List.Item>
                <b>Anonymous</b> -" Lets nuture the nature,so that we can have
                better future."
              </List.Item>
              <List.Item>
                <b>Mahatma Gandhi</b> – "Earth provides enough to satisfy every
                man's needs,but not every man's greed."
              </List.Item>
              <List.Item>
                <b>Lady Bird johnson</b> – "The environment is where we all
                meet;where all have a mutual interest; it is the one thing all
                of us share."
              </List.Item>
            </List>
